...
// ---------------------------------------------------------
/// Appends pointers to all the PdmPtrFields containing a
/// pointer to this object. As the PdmPtrArrayFields can hold
/// several pointers to the same object, the returned vector
/// can contain multiple pointers to the same field.
// ---------------------------------------------------------
void PdmObjectHandle::referringPtrFields(
  std::vector<PdmFieldHandle*>& fieldsReferringToMe) const {
...
// ---------------------------------------------------------
void PdmObjectHandle::objectsWithReferringPtrFields(
  std::vector<PdmObjectHandle*>& objects) const {
...
// ---------------------------------------------------------
void PdmObjectHandle::addField(PdmFieldHandle* field,
...
// ---------------------------------------------------------
// These two functions can be used when PdmCore
// is used standalone without PdmUi/PdmXml
/*
