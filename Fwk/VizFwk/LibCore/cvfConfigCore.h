...
// ---------------------------------------------------------------
// Define this one to tell windows.h to not define min() and
// max() as macros
...
// ---------------------------------------------------------------
// Used to keep track of all instances of classes derived from
// Object.
//
// Can be used to detect memory leaks in combination with the
// static member functions: Object::activeObjectInstances() and
// Object::dumpActiveObjectInstances()
//
...
// In debug builds, all asserts are in action, including tight
// asserts
// In release builds, tight asserts are disabled by default.
// Normal asserts are still in action (including CVF_FAIL_...)
