...
// ===============================================================
// Transforms origin and direction with the given transformation
// matrix
...
//
// intersectionPoint (if not NULL) will be set to the ray
// intersection point on the quad.
...
//
// intersectionPoint (if not NULL) will be set to
// the ray intersection point on the bounding box.
...
// ===============================================================
// Returns true if the ray intersects the ray (plane?)
