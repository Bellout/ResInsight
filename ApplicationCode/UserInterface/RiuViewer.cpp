    ...
    : caf::Viewer(format, parent), m_isNavigationRotationEnabled(true)
{
  ...
  versionInfoPalette.setColor(QPalette::LinkVisited, versionInfoLabelColor);
  m_versionInfoLabel->setPalette(versionInfoPalette);

  QFont m_versionInfoFont = m_versionInfoLabel->font();
  m_versionInfoFont.setPixelSize(18);
  m_versionInfoLabel->setFont(m_versionInfoFont);
