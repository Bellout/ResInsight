                                              ...
                                              RigEclipseCaseData* eclipseCase)
{
  ...
  for (lgrIdx = 0; lgrIdx < numLGRs; ++lgrIdx)
  {
    ...
    activeCellInfo->setGridActiveCellCounts(lgrIdx + 1,
                                            matrixActiveCellCount);

    fractureActiveCellInfo->setGridActiveCellCounts(lgrIdx + 1,
...
bool RifReaderEclipseOutput::open(const QString& fileName,
  ...
  if (isNNCsEnabled())
  {
    ...
    transferStaticNNCData(mainEclGrid,
                          m_ecl_init_file,
                          eclipseCase->mainGrid());
    progInfo.incrementProgress();
    ...
    {
      transferDynamicNNCData(mainEclGrid,
                             eclipseCase->mainGrid());
    }
    progInfo.incrementProgress();
