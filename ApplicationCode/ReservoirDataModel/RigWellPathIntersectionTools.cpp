...
RigWellPathIntersectionTools::findRawHexCellIntersections(const RigMainGrid* grid,
  ...
  for (size_t i = 0; i < coords.size() - 1; ++i) {
    ...
    for (size_t closeCell : closeCells)
    {
      ...
      RigHexIntersectionTools::lineHexCellIntersection(coords[i],
                                                       coords[i + 1],
                                                       hexCorners.data(),
                                                       closeCell,
                                                       &intersections);
...
//--------------------------------------------------------------------------------------------------
cvf::Vec3d
RigWellPathIntersectionTools::calculateLengthInCell(const std::array<cvf::Vec3d, 8>& hexCorners,
