...
RigResultAccessorFactory::createFromUiResultName(const RigEclipseCaseData* eclipseCase,
                                                                             size_t gridIndex,
  ...
  return RigResultAccessorFactory::createNativeFromUiResultName(eclipseCase,
                                                                gridIndex,
                                                                porosityModel,
                                                                timeStepIndex,
                                                                uiResultName);
...
//--------------------------------------------------------------------------------------------------
cvf::ref<RigResultAccessor>
RigResultAccessorFactory::createDerivedResultAccessor(const RigEclipseCaseData* eclipseCase,
                                                                                  size_t gridIndex,
                                                                                  RiaDefines::PorosityModelType porosityModel,
                                                                                  size_t timeStepIndex,
                                                      const QString& uiResultName) {
  ...
  if (uiResultName == RiaDefines::combinedTransmissibilityResultName()) {
    ...
    // Static result, only data for first time step
    ...
    cvf::ref<RigResultAccessor> xTransAccessor =
        RigResultAccessorFactory::createNativeFromUiResultName(eclipseCase,
                                                               gridIndex,
                                                               porosityModel,
                                                               timeStepIndex,
                                                               "TRANX");
    ...
    cellFaceAccessObject->setTransResultAccessors(xTransAccessor.p(),
                                                  yTransAccessor.p(),
                                                  zTransAccessor.p());
    ...
    cvf::ref<RigResultAccessor> multYPos =
        RigResultAccessorFactory::createNativeFromUiResultName(eclipseCase, gridIndex, porosityModel, timeStepIndex, "MULTY");

    cvf::ref<RigResultAccessor> multYNeg =
        RigResultAccessorFactory::createNativeFromUiResultName(eclipseCase, gridIndex, porosityModel, timeStepIndex, "MULTY-");

    cvf::ref<RigResultAccessor> multZPos =
        RigResultAccessorFactory::createNativeFromUiResultName(eclipseCase, gridIndex, porosityModel, timeStepIndex, "MULTZ");
...
//--------------------------------------------------------------------------------------------------
cvf::ref<RigResultAccessor>
RigResultAccessorFactory::createFromResultIdx(const RigEclipseCaseData* eclipseCase,
                                                                          size_t gridIndex,
                                                                          RiaDefines::PorosityModelType porosityModel,
                                                                          size_t timeStepIndex,
                                              size_t resultIndex) {
  ...
  const std::vector< std::vector<double> >&
      scalarSetResults =
      eclipseCase->results(porosityModel)->cellScalarResults(resultIndex);
  ...
  bool useGlobalActiveIndex =
      eclipseCase->results(porosityModel)->isUsingGlobalActiveIndex(resultIndex);
  ...
  if (useGlobalActiveIndex) {
    ...
    cvf::ref<RigResultAccessor> object =
        new RigAllGridCellsResultAccessor(grid,
                                          resultValues);
        return object;
    }
}
