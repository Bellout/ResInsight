...
class RigReservoirBuilderMock
{
 public:
  ...
  // -------------------------------------------------------------
  void setWorldCoordinates(cvf::Vec3d minWorldCoordinate,
  ...
  // -------------------------------------------------------------
  bool inputProperty(RigEclipseCaseData* eclipseCase,
                     const QString& propertyName,
                     std::vector<double>* values );

  // -------------------------------------------------------------
  bool staticResult(RigEclipseCaseData* eclipseCase,
 ...
 private:
  ...
  // -------------------------------------------------------------
  static void appendCells(size_t nodeStartIndex,
                          size_t cellCount,
  ...
  // -------------------------------------------------------------
  static void appendCubeNodes(const cvf::Vec3d& min,
                              const cvf::Vec3d& max,
                              std::vector<cvf::Vec3d>& nodes);
