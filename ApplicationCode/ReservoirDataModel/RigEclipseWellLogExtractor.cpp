...
// NOT USED
//      int intersectionCount = RigHexIntersector::lineHexCellIntersection(p1, p2,
//                                                                         hexCorners,
//                                                                         closeCells[cIdx],
//                                                                         &intersections);
      RigHexIntersectionTools::lineHexCellIntersection(p1, p2,
                                                       hexCorners,
                                                       closeCells[cIdx],
                                                       &intersections);
    }
...
//--------------------------------------------------------------------------------------------------
void
RigEclipseWellLogExtractor::curveData(const RigResultAccessor* resultAccessor,
